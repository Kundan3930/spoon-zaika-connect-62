      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="animate-fade-up" style={{ animationDelay: '0.1s' }}>
            <h3 className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-orange-500">QuickBite</h3>
            <p className="text-gray-400 mb-4">
              Making campus dining convenient and delicious. Order from your favorite university restaurants with ease.
            </p>
          ...
          <div className="animate-fade-up" style={{ animationDelay: '0.2s' }}>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-blue-500 transition-colors">Contact</Link>
              </li>
              <li>
                <Link to="/login" className="text-gray-400 hover:text-blue-500 transition-colors">Sign In</Link>
              </li>
              <li>
                <Link to="/signup" className="text-gray-400 hover:text-blue-500 transition-colors">Sign Up</Link>
              </li>
            </ul>
          </div>
